...
CREATE TABLE "AIPromptUsage" (
    ...
    CONSTRAINT "AIPromptUsage_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "AIPromptUsage_userId_createdAt_idx" ON "AIPromptUsage"("userId", "createdAt");

-- CreateIndex
CREATE INDEX "AIPromptUsage_workspaceId_createdAt_idx" ON "AIPromptUsage"("workspaceId", "createdAt");
...
-- AddForeignKey
ALTER TABLE "WorkspaceInvitation" ADD CONSTRAINT "WorkspaceInvitation_inviterId_fkey" FOREIGN KEY ("inviterId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
